...
public:
    Address() {
        set("0", "Road", "District", "Sub district", "Province", "Post code");
        cout << "Add" << endl;
    }
...
public:
    Student() {
        set("1111111111", "Faculty", "Department");
        show();
    }
    ...
    /*tudent(string id, string fname, string lname, int d, int m, int y,
        string stdID, string fac, string de,Address add) {
        set(stdID, fac, de);
        setID(id);
        setName(fname, lname);
        setBirthday(d, m, y);
...
public:
    ...
    /*Teacher(string id, string fname, string lname, int d, int m, int y,
        string tID, string fac, string de,Address add) {
        set(tID, fac, de);
        setID(id);
        setName(fname, lname);
        setBirthday(d, m, y);
...
int main()
{
    ...
    s2.Person::show();
    s2.show();  cout << endl;
    a1.set("31", "a", "b", "c", "d", "1997");
    t2.Person::set("3105199712345", "Jeong", "Sewoon", 31, 5, 1997, a1);
    t2.Person::show();  
    t2.show();          cout << endl;
    ...
    cout << "----" << endl;
    n1.show2();  cout << endl;
    Teacher m1("3105199712345", "Jeong", "Sewoon", 31, 5, 1997, "6405001097", "Scince", "Computer", a1);
    //m1.Person::show();
    m1.show2();  cout << endl;
}